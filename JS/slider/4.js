...
console.log(nutnay);
    ...
    function auto() {
        var thoigian = setInterval(function () {
            ...
            if (vitrislide == slides.length - 1) { // vitrislide = 2; slides.leght = 3 - 1 = 2
...
// function showDivs(n) {
//     var i;
//     var x = document.querySelectorAll('div.slide div');
//     // console.log('asdasds' + x);
//     if (n > x.length) { slideIndex = 1 }
//     if (n < 1) { slideIndex = x.length }
//     for (i = 0; i < x.length; i++) {
//         // x[i].style.opacity = 0;
//         x[i].classList.remove('ra');
//     }
//     // x[slideIndex - 1].style.opacity = 1;
//     x[slideIndex - 1].classList.add('ra');
//     for (var i = 0; nutnay = nutnay.previousElementSibling; vitrislide++) {
//         //chay den khi nut nay  = null thi dung.
//         // chay xong lenh nay khi click vao nut ta lay dc vitrislide
